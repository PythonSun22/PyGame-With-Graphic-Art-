...
class Player:
    ...
    def collides_with_any(self, colliders):
        ...
        for collider in colliders:
            if player_hitbox.colliderect(collider):
                return True
        return False

    @property
    def hitbox(self):
        # Slightly smaller than the full body rect
        # Helps movement feel less sticky
        r = self.rect
...
class Prop:
    ...
    @property
    def collider(self):
        # Slightly smaller bottom portion to feel more natural
        return pygame.Rect(
            self.rect.x + 4,
            self.rect.y + 10,
            self.rect.w - 8,
    ...
    def draw(self, screen):
        ...
        # Debug: draw collider
        # pygame.draw.rect(screen, (80, 255, 80), self.collider, 1)
...
def main():
    ...
    while running:
        ...
        colliders = [prop.collider for prop in props]
        player.move(keys, colliders)
